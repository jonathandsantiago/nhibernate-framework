...
namespace Apresentacao
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddNhibernateSql(Configuration, executeSchemaUpdate: true);

            AutoMapperConfiguration.Configure();
            services.AddTransient<IServiceUnitOfWork, ServiceUnitOfWork>();
            services.AddSingleton<ITesteGuidServico, TesteGuidServico>();
            services.AddSingleton<ITesteServico, TesteServico>();
